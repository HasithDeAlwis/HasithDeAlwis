...
(setq user-full-name "Hasith De Alwis"
      user-mail-address "hasithde24@gmail.com")
...
(setq fancy-splash-image "~/doom-emacs-color2.svg")
;; Custom text to display after the banner
(after! doom-dashboard
  (defun my-custom-dashboard-text ()
    "Insert custom text into the Doom dashboard."
    (insert "\"Do not proceed with a mess; messes just grow with time.\" ― Bjarne Strostrup\n\n"))
...
(setq org-agenda-files '("~/Desktop/org/University/2024-2025/plan.org"))

(require 'org)
(setq org-deadline-warning-days 1)
(setq calendar-mark-diary-entries-flag t)

(add-hook 'calendar-load-hook 'org-agenda-to-appt)
(add-hook 'diary-list-entries-hook 'org-diary)
